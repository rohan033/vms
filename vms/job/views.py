...
from job.services import get_job_by_id, check_edit_job, get_jobs_by_event_id, remove_empty_jobs_for_volunteer,remove_invalid_events
...
def list_sign_up(request, event_id, volunteer_id):
    if event_id:
        ...
        if event:
            ...
            job_list = remove_invalid_events(job_list)
